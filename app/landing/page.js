...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-purple-900 via-gray-900 to-red-900 text-white">
      <nav className="container mx-auto px-6 py-4">
        <Navbar />
      </nav>
      <section className="container mx-auto px-6 py-16 text-center">
        <h1 className="text-4xl md:text-7xl font-bold  mb-6">Bet on Your Favorite Football match</h1>
        <p className="text-2xl mb-12">Intent based and fan token gated fantasy betting app !</p>
      ...
      <section className="container mx-auto px-10 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-gray-800 rounded-lg p-6 transform transition duration-500 hover:scale-105">
            <h3 className="text-xl font-semibold mb-4">Wide Range of Games</h3>
            <p>Bet on various sports events from around the world.</p>
          </div>
          <div className="bg-gray-800 rounded-lg p-6 transform transition duration-500 hover:scale-105">
      ...
      <section className="container mx-auto px-6 py-16 text-center">
        ...
        <p className="text-xl mb-12">Create an account now and get a welcome bonus!</p>
        <a href="#" className="bg-red-600 hover:bg-red-700 text-white font-bold py-3 px-8 rounded-full transition duration-300">
          Sign Up Now
        </a>
      </section>
          ...
          <div className="flex flex-wrap justify-between">
            ...
            <div className="w-full md:w-1/4 mb-6 md:mb-0">
              ...
              <ul className="text-gray-400">
                ...
                <li className="mb-2"><a href="#" className="hover:text-white">Games</a></li>
            ...
            <div className="w-full md:w-1/4 mb-6 md:mb-0">
              ...
              <ul className="text-gray-400">
                ...
                <li className="mb-2"><a href="#" className="hover:text-white">Responsible Gaming</a></li>
              </ul>
            </div>
